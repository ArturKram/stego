...
<body data-spy="scroll">
  ...
  <div id="servic" class="container">
    <h5 align="center">ПОИСК ОБЪЕКТОВ <br>(в рамках конкретного дела):</h5>
        <hr class="separetor">


        <br>
  <form action="search_key_reg.php" method="POST" enctype="multipart/form-data">
        <div class="modal-title col-md-9 offset-md-3 text-uppercase font-weight-bold font-italic " style=" margin-left: 25%">
          <h5 style="color: rgb(0, 0, 0);font-size:16px;margin-left:23%;" >Выберите проверку</h5>
      </div>
<br>
      <div class="form-group row  offset-md-1">

      <br>
         <select name="check_name" class=" col-md-5 form-control" style="margin-left:29%;">
      <?php
...
<br>
      ...
      <button type="submit" class="btn btn-outline-light" name="search_name" style="margin-left:45%"> Поиск по базе</button>
