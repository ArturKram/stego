...
if(isset($_POST['check']))
 ...
 {
   echo "<b style='  margin-left: 9%;  font-size: 20px;'>Данные успешно добавлены в EXCEL.</b>"; // не сработало :(.
...
/*
 ...
 $path_file = $_SERVER['DOCUMENT_ROOT']."/".$upload_path . $filename;
   ...
   { echo "<b><h3 style='color: rgb(253, 253, 250)'>Ваш файл успешно загружен!<br>"; // сработало.
$hash_md5 = md5_file($path_file);
$hash_sha1 = sha1_file($path_file);
$hash_sha256 = hash('sha256', $path_file);


echo "<b><h3 style='color: rgb(253, 253, 250); '>SHA1 файла: ".$hash_sha1."<br>";
echo "<b><h3 style='color: rgb(253, 253, 250); '>SHA256   файла: ".$hash_sha256."<br>";
echo "<b><h3 style='color: rgb(253, 253, 250); '>MD5 файла: ".$hash_md5."<br>";
