...
<body data-spy="scroll">
  ...
  <div id="servic" class="container">
    <h5 align="center">ДОБАВИТЬ ФАЙЛ:</h5>
        <hr class="separetor">
      ...
      <form action="file_upload.php" method="post" enctype="multipart/form-data">
              ...
              <div class="custom-file col-md-4 offset-md-3"  style=" padding: 14px; margin-bottom: 10%; margin-left: 69%; display: inline-flex;">

                  <input type="file" class="btn btn-outline-light" name="userfile" id="file" style="color: white; width: 325px;" type="button">

                                <button  class="btn btn-outline-light" style="margin-left: 32%;"> <b>Добавить хеш</b></button>
                  </div>
                              </div>
