...
<body data-spy="scroll">
  ...
  <div id="servic" class="container">
    <h5 align="center">ДОБАВИТЬ КЛЮЧИ РЕЕСТРА:</h5>
        <hr class="separetor">


        <br>
        <br>
        <form action="key_upload.php" method="post" enctype="multipart/form-data">
...
<div class="custom-file col-md-4 offset-md-3" style="margin-left: 62%;display: inline-flex;  height: 92px; width: 650px;margin-bottom: 10%;">

  <input type="file" class="btn btn-outline-light" name="userfile" id="file" style="color: white;width: 53%;" type="button">&nbsp
  <button  class="btn btn-outline-light"  style="margin-left: 8%;"><b>Добавить</b></button>
                  </div>
                              </div>
