...
<body data-spy="scroll">
  ...
  <div id="servic" class="container">
    <h5 align="center"> СОЗДАНИЕ ПОИСКОВОГО ДЕЛА</h5>
        <hr class="separetor">

                      <!--    <div class="modal-title col-md-9 offset-md-3 text-uppercase font-weight-bold font-italic " style=" margin-left: 32%">

             <b><h5 style="color: rgb(0, 0, 0)" >Введите имя проверки</h5></b>
        </div> -->
<br><br>
        <form action="directory_upload.php" method="POST" enctype="multipart/form-data">
        <div class="offset-md-1">
            <input class=" col-md-5" type="text" name="check_name" placeholder="Введите имя проверки" style="padding: 6px; font-size: 18px;margin-left: 29%" />
    &nbsp;&nbsp;
         <button type="submit" class="btn btn-outline-light" name="add_check_name">Добавить проверку</button>
         <br>
         <br>
