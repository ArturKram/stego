...
<body data-spy="scroll">
  ...
  <div id="servic" class="container">
    <h5 align="center">ВЫГРУЗКА В EXCEL:</h5>
        <hr class="separetor">

        <br>
        <br>

      <form action="file_excel.php" method="post" enctype="multipart/form-data">

                              <div class="input-group" style="margin-top: -3%;">
                                <div class="custom-file col-md-4 offset-md-3"  style=" padding: 14px;  margin-right: 500px; margin-left: 41%;">
                                ...
                                <button  class="btn btn-outline-light" style="    margin-left: 17%; margin-top: 10%;" > <b>Выгрузить в excel</b></button>
                  </div>
                              </div>
