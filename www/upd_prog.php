...
<body data-spy="scroll">
  ...
  <div id="servic" class="container">
    <h5 align="center">РЕДАКТИРОВАТЬ СТЕГАНОПРОГРАММУ:</h5>
        <hr class="separetor">
<br>
        <div class="container col-md-10 offset-md-1">
          <form method= "post" action="prog_update.php">

  <div class="form-group row offset-md-1">
    <label style="color: rgb(0, 0, 0);" class= "col-md-2 col-form-label"><h5 style="margin-left: 23%;">Стеганопрограмма</h5></label>
     <select name="st_name_upd" class=" col-md-5 form-control" style="  width: 30%;  border: 4px solid #ced4da; margin: 0%; margin-left: 10%;">
  <?php
  ...
  ?>
         ...
         <button name= "upd" type="submit" class="btn btn-outline-light offset-md-1" style="margin-left: 32.5%;"> <b>РЕДАКТИРОВАТЬ СТЕГАНОПРОГРАММУ</b></button>
         <br><br>
         <br>
	</div>
